                ...
                <div className='divide-y divide-gray-100 dark:divide-gray-700'>
                  ...
                  {keywordResults[type].map((item: any, i: any) => {
                    ...
                    return (
                      <div
                        key={i}
                        className='p-3 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group gap-2 sm:gap-0'
                      >
