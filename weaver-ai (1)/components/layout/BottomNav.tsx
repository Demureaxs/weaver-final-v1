...
import { usePathname, Link } from '../NextShim'; // LOCALLY: import { usePathname } from 'next/navigation'; import Link from 'next/link';
...
export const BottomNav = () => {
  ...
  const navItems = [
    ...
    { label: 'Generator', path: '/generator', icon: Sparkles, color: 'indigo' },
    { label: 'Keywords', path: '/keywords', icon: Search, color: 'indigo' },
    { label: 'Sitemap', path: '/sitemap', icon: Map, color: 'indigo' },
    // Adding placeholder for future book writer
    { label: 'Books', path: '/book-writer', icon: BookOpen, color: 'purple' }, 
  ];
