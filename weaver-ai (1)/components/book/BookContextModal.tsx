...
export const BookContextModal = ({ isOpen, onClose, onSave, initialData, userApiKey }: BookContextModalProps) => {
  ...
  const handleAiGenerate = async (field: string) => {
    ...
    try {
      ...
      const prompt = `Generate a concise (max 50 words) ${field} description for a book titled "${initialData.title}" (${initialData.genre}). 
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white dark:bg-gray-800 w-full max-w-2xl rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto m-4">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6">
             <div className="space-y-2">
              <div className="flex justify-between">
                <label className="text-xs font-bold text-gray-500 uppercase flex items-center gap-2"><Palette size={12} /> Tone / Atmosphere</label>
              </div>
              <input 
                type="text" 
                value={formData.tone} 
            ...
            <div className="relative">
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-2 flex gap-2 items-center border border-purple-100 dark:border-purple-800/50">
                   ...
                   <input 
                    ...
                    onChange={(e) => { setActiveField('storyArc'); setAiPrompt(e.target.value); }}
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-end">
               <label className="text-xs font-bold text-gray-500 uppercase flex items-center gap-2"><Map size={12} /> Setting / Environment</label>
               <span className="text-[10px] text-purple-500 flex items-center gap-1"><Sparkles size={10} /> AI Enabled</span>
            </div>
            <div className="relative">
                <textarea 
                ...
                />
                 ...
                 <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-2 flex gap-2 items-center border border-purple-100 dark:border-purple-800/50">
                   ...
                   <input 
                    ...
                    onChange={(e) => { setActiveField('setting'); setAiPrompt(e.target.value); }}
