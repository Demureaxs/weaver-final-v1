...
export default function SitemapPage() {
  ...
  return (
    <SitemapView
        sitemapInputType={sitemapInputType} setSitemapInputType={setSitemapInputType}
        sitemapUrl={sitemapUrl} setSitemapUrl={setSitemapUrl}
        sitemapText={sitemapText} setSitemapText={setSitemapText}
        handleSitemapFetch={handleSitemapFetch}
        sitemapStatus={sitemapStatus}
        sitemapError={sitemapError}
        discoveredUrls={discoveredUrls}
        omitBaseUrl={omitBaseUrl} setOmitBaseUrl={setOmitBaseUrl}
    />
  );
}
