...
export const BottomNav = () => {
  ...
  const navItems = [
    ...
    { label: 'Books', path: '/dashboard/book-writer', icon: BookOpen, color: 'indigo' },
  ];
          ...
          return (
            <Link
              ...
              className={`flex-1 p-2 rounded-xl flex flex-col items-center transition-colors ${
                active
                  ? `text-${item.color}-600 dark:text-${item.color}-400 bg-${item.color}-50 dark:bg-${item.color}-900/20`
